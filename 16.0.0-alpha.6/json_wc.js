(self["webpackChunkplugin_amcharts5"] = self["webpackChunkplugin_amcharts5"] || []).push([[978],{
...
/* harmony export */ });
/* harmony import */ var _WordCloudDefaultTheme__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./WordCloudDefaultTheme */ 32525);
...
/* harmony import */ var _core_util_Color__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../core/util/Color */ 19896);
...
/* harmony import */ var _core_util_Math__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../core/util/Math */ 16979);
...
class WordCloud extends _core_render_Series__WEBPACK_IMPORTED_MODULE_0__.Series {
  ...
  makeLabel(dataItem) {
    ...
    ghostLabel.setAll({
      fill: _core_util_Color__WEBPACK_IMPORTED_MODULE_3__.Color.fromHex(0x000000),
      fontWeight: "900"
    });
          ...
          if (p) {
            ...
            if (p.x - lw / 2 < 0 || p.x + lw / 2 > w || p.y - lh / 2 < 0 || p.y + lh / 2 > h) {
              ...
              if (!intersects) {
                ...
                this._boundsToAdd = {
                  left: (p.x + x - lw / 2) * resolution,
                  right: (p.x + x + lw / 2) * resolution,
                  top: (p.y + y - lh / 2) * resolution,
                  bottom: (p.y + y + lh / 2) * resolution
                };
              } else {
                pIndex += 2;
              }
...
/* harmony import */ var _core_render_Rectangle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../core/render/Rectangle */ 26622);
...
/* harmony export */ });
/* harmony import */ var _internal_charts_wordcloud_WordCloud__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./.internal/charts/wordcloud/WordCloud */ 98026);
/* harmony import */ var _internal_charts_wordcloud_WordCloudDefaultTheme__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./.internal/charts/wordcloud/WordCloudDefaultTheme */ 32525);
...
//# sourceMappingURL=json_wc.js.map